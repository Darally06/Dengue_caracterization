...
![alt text](casos_col.png)
![alt text](incidencia_col.png)
...
![alt text](casos_atl.png)
![alt text](incidencia_atl.png)
...
Para este estudio se incorporó la **Razón Estandirizada de morbilidad (REM)** como indicador complementario a la incidencia, con el fin de capturar diferencias en el riesgo epidemiologico que no se explican unicamente por el tamaño poblacional o el número absoluto de casos. Mientras la incidencia muestra la frecuencia de la enfermedad ajustada por la población, el REM permite comparar cada municipio contra un patrón de referencia departamental, identificando territorios donde la carga observada supera o se encuentra debajo de lo esperado. Su utilidad radica en que revela desigualdades relativas en la transmisión del dengue, permitiendo reconocer áreas con un riesgo inusualmente alto - pontenciales escenarios de brote, condiciones ambientales favorables o brechas en vigilancia- así como municipios que mantienen una transmisión por debajo del nivel esperado. En conjunto, ambos indicadores ofrecen una visión más precisa de las dinámicas locales del dengue en el Atlántico durante el periodo **2018-2023**.
...
La tabla sintetiza estos resultados para los municipios del departamento, mostrando para cada uno la incidencia acumulada y el REM durante el periodo de estudio. Municipios como **Soledad, Sabanalarga, Baranoa, Puerto Colombia, Galapa** y **Malambo** presentan tanto una alta incidencia como valores de REM superiores a 1, lo que indica una transmisión más intensa que la esperada para su tamaño poblacional. Otros municipios de menor población, como **Polonuevo** y **Usiacurí**, destacan por REM particularmente elevados, sugiriendo brotes localizados o condiciones de vulnerabilidad específicas. En contraste, municipios como **Campo de la Cruz, Candelaria, Sabanagrande, Santo Tomás, Palmar de Varela** o **Repelón** registran incidencias bajas y REM inferiores a 1, señalando niveles de transmisión por debajo del comportamiento esperado para el departamento. En conjunto, esta distribución confirma que el riesgo de dengue en el Atlántico es heterogéneo y que algunos municipios requieren mayor priorización en la vigilancia y las intervenciones de control vectorial.
