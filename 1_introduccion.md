...
## **Jutificación** 
[comment]: <> (¿Pq usamos los factores del entorno?)

## **Objetivos**
Analizar la distribución de los casos de dengue en el departamento del Atlántico al identificar factores del entorno asociados en el periodo 2017-2023.

* Identificar las subregiones de mayor vulnerabilidad en el Atlántico
* Determinar la asociación de factores del entorno con la presencia del Dengue. 
* Describir el comportamiento temporal y espacial de la incidencia del dengue en el Atlántico entre los años 2017-2023. 

## **Sobre el trabajo**
Este trabajo hace parte de los resultados del curso Seminario Investigativo del pregrado en Ciencia de Datos de la Universidad del Norte.
